...
{
    function AdvWidget(){
		$widget_ops = array('description' => 'Mostra imagens como banners');
		$control_ops = array('width' => 400, 'height' => 500);
		parent::WP_Widget(false,$name='Banners',$widget_ops,$control_ops);
	}
...
while ($i <= 8):
if ($bannerPath[$i] <> '') { ?>
<?php if ($bannerTitle[$i] == '') $bannerTitle[$i] = "banners";
	  if ($bannerAlt[$i] == '') $bannerAlt[$i] = "banners"; ?>
...
<?php
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
		...
		<label for="<?php echo $this->get_field_id('use_relpath'); ?>">Use o caminho relativo da imagem</label><br />
		...
		<?php	# Banner #1 Imagem
		echo '<p><label for="' . $this->get_field_id('bannerOnePath') . '">' . 'Banner #1 Imagem:' . '</label><input class="widefat" id="' . $this->get_field_id('bannerOnePath') . '" name="' . $this->get_field_name('bannerOnePath') . '" type="text" value="' . $bannerPath[1] . '" /></p>';
		# Banner #1 Url
		...
		# Banner #2 Imagem
		echo '<p><label for="' . $this->get_field_id('bannerTwoPath') . '">' . 'Banner #2 Imagem:' . '</label><input class="widefat" id="' . $this->get_field_id('bannerTwoPath') . '" name="' . $this->get_field_name('bannerTwoPath') . '" type="text" value="' . $bannerPath[2] . '" /></p>';
		# Banner #2 Url
		...
		# Banner #3 Imagem
		echo '<p><label for="' . $this->get_field_id('bannerThreePath') . '">' . 'Banner #3 Imagem:' . '</label><input class="widefat" id="' . $this->get_field_id('bannerThreePath') . '" name="' . $this->get_field_name('bannerThreePath') . '" type="text" value="' . $bannerPath[3] . '" /></p>';
		# Banner #3 Url
		...
		# Banner #4 Imagem
		echo '<p><label for="' . $this->get_field_id('bannerFourPath') . '">' . 'Banner #4 Imagem:' . '</label><input class="widefat" id="' . $this->get_field_id('bannerFourPath') . '" name="' . $this->get_field_name('bannerFourPath') . '" type="text" value="' . $bannerPath[4] . '" /></p>';
		# Banner #4 Url
		...
		# Banner #5 Imagem
		echo '<p><label for="' . $this->get_field_id('bannerFivePath') . '">' . 'Banner #5 Imagem:' . '</label><input class="widefat" id="' . $this->get_field_id('bannerFivePath') . '" name="' . $this->get_field_name('bannerFivePath') . '" type="text" value="' . $bannerPath[5] . '" /></p>';
		# Banner #5 Url
		...
		# Banner #6 Imagem
		echo '<p><label for="' . $this->get_field_id('bannerSixPath') . '">' . 'Banner #6 Imagem:' . '</label><input class="widefat" id="' . $this->get_field_id('bannerSixPath') . '" name="' . $this->get_field_name('bannerSixPath') . '" type="text" value="' . $bannerPath[6] . '" /></p>';
		# Banner #6 Url
		...
		# Banner #7 Imagem
		echo '<p><label for="' . $this->get_field_id('bannerSevenPath') . '">' . 'Banner #7 Imagem:' . '</label><input class="widefat" id="' . $this->get_field_id('bannerSevenPath') . '" name="' . $this->get_field_name('bannerSevenPath') . '" type="text" value="' . $bannerPath[7] . '" /></p>';
		# Banner #7 Url
		...
		# Banner #8 Imagem
		echo '<p><label for="' . $this->get_field_id('bannerEightPath') . '">' . 'Banner #8 Imagem:' . '</label><input class="widefat" id="' . $this->get_field_id('bannerEightPath') . '" name="' . $this->get_field_name('bannerEightPath') . '" type="text" value="' . $bannerPath[8] . '" /></p>';
		# Banner #8 Url
